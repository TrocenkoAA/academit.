...
namespace ShapesProject
{
    class Program
    {
        public static string GetMaxAreaShape(IShape[] shapesArray)
        {
            ...
            return shapesArray[shapesArray.Length - 1].ToString();
        }
        ...
        public static string GetNextToMaxPerimeterShape(IShape[] shapesArray)
        {
            ...
            return shapesArray[shapesArray.Length - 2].ToString();
        }

        static void Main(string[] args)
        {
            IShape[] shapesArray = new IShape[] { new Circle(4), new Rectangle(2, 4), new Triangle(1, 4, 2, -2, 4, 3), new Square(6),
                                                  new Circle(3), new Rectangle(3, 2), new Triangle(-1, 4, 2, -2, 4, 2), new Square(8) };
